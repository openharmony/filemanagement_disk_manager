...
static const std::unordered_map<int32_t, int32_t> errCodeTable {
    ...
    { E_DELETE_PARTITION_NOT_SUPPORT, E_SUPPORTEDFS },
    { E_FORMAT_PARTITION_NOT_SUPPORT, E_SUPPORTEDFS },
    // volumeManager 光盘/刻录扩展错误码映射
    { E_STORAGE_JS_EXT_EMPTY_DISC, E_JS_EXT_EMPTY_DISC },
    { E_STORAGE_JS_EXT_ISO_WRITE_FAILED, E_JS_EXT_ISO_WRITE_FAILED },
    { E_STORAGE_JS_EXT_ERASE_FAILED, E_JS_EXT_ERASE_FAILED },
    { E_STORAGE_JS_EXT_BURN_SRC_NOTFOUND, E_JS_EXT_BURN_SRC_NOTFOUND },
    { E_STORAGE_JS_EXT_BURN_FAILED, E_JS_EXT_BURN_FAILED },
    { E_STORAGE_JS_EXT_NO_ONGOING_OP, E_JS_EXT_NO_ONGOING_OP },
    { E_STORAGE_JS_EXT_VERIFY_FAILED, E_JS_EXT_VERIFY_FAILED },
    { E_STORAGE_JS_EXT_VERIFY_MISMATCH, E_JS_EXT_VERIFY_MISMATCH }
};
