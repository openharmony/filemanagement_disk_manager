...
const std::string GPT_PARTITION_TYPE_GUID = "0FC63DAF-8483-4772-8E79-3D69D8477DE4";
const std::string GPT_TYPE_CODE_GUID = "EBD0A0A2-B9E5-4433-87C0-68B6B72699C7";
} // namespace
...
{
    PartitionParams params(flag, flag, flag * SECTOR_MULTIPLIER, GPT_PARTITION_TYPE_GUID);
    ...
    params.SetTypeCode(GPT_TYPE_CODE_GUID);
