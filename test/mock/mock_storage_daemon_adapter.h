...
public:
    ...
    MOCK_METHOD(int32_t, CreateBlockDeviceNode, (const std::string &devPath, uint32_t mode, int32_t major, int32_t minor));
    MOCK_METHOD(int32_t, DestroyBlockDeviceNode, (const std::string &devPath));
    MOCK_METHOD(int32_t, ReadPartitionTable, (const std::string &devPath, std::string &output, int32_t &maxVolume));
    ...
    MOCK_METHOD(int32_t, Mount, (const std::string &devPath, const std::string &mountPath, const std::string &fsType, uint64_t mountFlag, const std::string &mountData));
    ...
    MOCK_METHOD(int32_t, SetLabel, (const std::string &devPath, const std::string &fsType, const std::string &label));
    MOCK_METHOD(int32_t, ReadMetadata, (const std::string &devPath, std::string &uuid, std::string &type, std::string &label));
    MOCK_METHOD(int32_t, GetCapacity, (const std::string &mountPath, int64_t &totalSize, int64_t &freeSize));
    ...
    MOCK_METHOD(int32_t, FormatPartition, (const std::string &devPath, const std::string &fsType, const std::string &volumeName, bool quickFormat));
