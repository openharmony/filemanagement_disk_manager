...
public:
    ...
    MOCK_METHOD(int32_t, Erase, (const std::string &volumeId), (override));
    MOCK_METHOD(int32_t, Eject, (const std::string &diskId), (override));
    MOCK_METHOD(int32_t, CreateIsoImage, (const std::string &volumeId, const std::string &filePath), (override));
    MOCK_METHOD(int32_t, Burn, (const std::string &volumeId, const std::string &burnOptions), (override));
