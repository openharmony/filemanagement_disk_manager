...
HWTEST_F(CryptParamTest, SetKeyFile_TestCase_001, TestSize.Level0)
{
    CryptParam cp;
    cp.SetKeyFile("/new/keyfile");
    EXPECT_EQ(cp.GetKeyFile(), "/new/keyfile");
}
...
HWTEST_F(CryptParamTest, Unmarshalling_Success_TestCase_001, TestSize.Level0)
{
    ...
    EXPECT_EQ(result->GetKeyFile(), "/keyfile");
    delete result;
}
...
HWTEST_F(CryptParamTest, Unmarshalling_OversizedKeyFile_TestCase_001, TestSize.Level0)
{
    Parcel parcel;
    parcel.WriteString("luks");
    parcel.WriteString("aes");
