...
constexpr int32_t E_STORAGE_JS_EXT_BURN_NOSPACE = STORAGE_SERVICE_SYS_CAP_TAG + 26;
...
constexpr int32_t E_DELETE_PARTITION_FAILED = STORAGE_SERVICE_SYS_CAP_TAG + 23; // 13600023 - conflicts with DISC_NOT_ERASABLE, use 13600023 in partition context
