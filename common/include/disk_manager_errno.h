...
enum DiskManagerErrNo : int32_t {
    ...
    E_QUERY_VOLUME_IN_USE_ERROR = 13600000 + 1751,

    // burn errno
    E_EMPTY_DISC = 13600000 + 1801,
    E_ISO_WRITE_FAILED = 13600000 + 1802,
    ...
    E_DESTROY_DM_CRYPT_VOLUME_FAILED = 13600000 + 1903,
    E_UNBIND_LOOP_DEV_FAILED = 13600000 + 1904,
    E_MOUNT_VOL_BY_PATH_FAILED = 13600000 + 1905,
    E_UMOUNT_VOL_BY_PATH_FAILED = 13600000 + 1906,
